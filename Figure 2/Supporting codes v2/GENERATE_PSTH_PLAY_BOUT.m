function psth_struct = GENERATE_PSTH_PLAY_BOUT(current_dir, wind_length, wind_overlap, min_separation, f, freq_pow_range)
...
%% Compute band-limited power PSTH around play bouts
hist_range       = [-20 20];
range_time_wrap  = [-5 5];
