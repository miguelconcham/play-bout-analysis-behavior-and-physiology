function psth_struct = GENERATE_PHASE_EXPLORATORY_ONSET(current_dir, Hd_freq1)
...
%% Extract phase around exploratory-bout onset/offset
hist_range = [-20 20];
lfp_sr     = 2500;
...
for ch_n = 1:numel(mid_PAG_channel)
    ...
    phase_data_this_channel = mod(phase_data_this_channel - mean_angle_original + 5 * pi, 2 * pi) - pi;
