function psth_struct = GENERATE_SPEED_FREQ_RELATION(animal_code, pt, freq_range, f, wind_length, wind_overlap)
% Relates band-limited LFP power to locomotion kinematics via linear model.
...
%% Load tracking and kinematic variables
...
%% Compute spectrogram and fit speed-power model
...
for ch_n = 1:numel(mid_PAG_channel)
    ...
    model_data = table(animal_speed_spect_time, animal_accel_spect_time, categorical(play_bout_index'), animal_dist_spect_time, animal_rel_speed_spect_time, freq_pow', ...
        'VariableNames', {'Speed', 'Acc', 'Play', 'Distance', 'RelativeSpeed', 'Power'});
