function psth_struct = GENERATE_DELTA_PSTH_ALL_BEHAVIORS(current_dir,wind_length,wind_overlap,min_separation,f,freq_pow_range )
...
for ch_n=1:numel(mid_PAG_channel)
    ...
    for beh_type = 1:numel(behaviors_this_session)
        ...
        this_behavior_tw                = nan(numel(behavior_index), round(range(range_time_wrap)/spect_bin_size)  ...
            + n_bins_time_wrap);
