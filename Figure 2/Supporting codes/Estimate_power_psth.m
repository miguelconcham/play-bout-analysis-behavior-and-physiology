...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% For selecting other behaviors you need to modify %%%%%%%%%%%
%%%% GENERATE_THETA_PSTH directly                     %%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%% Parameters for different freq bands %%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% save([saving_folder,'\psth_structure_gamma_play_bout.mat'],'psth_structure', '-v7.3');
% save([saving_folder,'\animal_names_gamma_play_bout.mat'],'animal_names');